...
3. Adicione o remote upstream para manter seu repositório local atualizado: `git remote add upstream https://github.com/vitorrezend/dio-lab-open-source.git`;
