...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/TU_USERNAME`: `git checkout -b feat/community/pea161207`;
    > Ejemplo: `git checkout -b feat/community/pea161207`
